...
async function startBotInner(myGen) {
    ...
    const handleMessageUpsert = require('./src/controllers/message.controller.js')(sock, K, {
        processedMsgIds, IGNORED_MESSAGE_TYPES, botSentIds, botSessions,
        recordMessage, nameMap, askedNameOnce, rememberBotSent, migratedLids, contactMap, photoBuffer, saveNameMap, saveStatus, downloadMediaMessage, pino, FormData, Blob, fetch, tandaiPerangkat, stripBotPrefix, stripInvisible, plainCommandWord, isAdminCall, botSessionActive, extractMessage, addToContext, adminCallMap, greetedMap, saveGreetedMap, markStateDirty: () => { isStateDirty = true; }
    });
